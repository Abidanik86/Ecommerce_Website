...
<div class="container">
    <br>
    <h1 class="header">ADD BANER ITEM'S </h1> 
    <br>
    <form action="{{route('upload.baner')}}" method="post" class="form-container" enctype="multipart/form-data">
        @csrf
        @method('post')
        ...
        <table id="customers">                 
            ...
            <tr>         
              ...
              <td ><img style="width:200px; height: 70px;  object-fit: cover; " src="/banerimage/{{$data->image}}" alt="Image"></td>       
